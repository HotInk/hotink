class CreateUsers < ActiveRecord::Migration
  def self.up
    create_table :users, :options => 'DEFAULT CHARSET=utf8' do |t|
      ...
      t.string    :single_access_token, :null => false, :default => ""# see Authlogic::Session::Params
      t.string    :perishable_token,    :null => false, :default => ""# see Authlogic::Session::Perishability
