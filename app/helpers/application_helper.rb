...
module ApplicationHelper
  ...
  def render_applications( account, user )
    case account.name
    when 'root', 'manit', 'fulcrum', 'sput', 'Muse', 'peak', 'martlet', 'mcgilldaily', 'Nexus', 'Xav', 'cord', 'campusfreepress', 'intercamp', 'otherpress' , 'CUP Wire', 'Quill', 'Sheaf1912', 'thestethoscope', 'naturalselection', 'varsity', 'capertimes'
